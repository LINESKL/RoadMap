  ...
  <transition name="fade-slide">
    <div class="auth2-layout" v-show="show">
      <div class="auth2-illustration">
        ...
        <img class="auth2-boy-img" src="@/assets/register.png" alt="boy with book" />
      </div>
      <div class="auth2-formbox">
        ...
        <form @submit.prevent="register">
          ...
          <div class="auth2-bottom">
            <span>Уже есть аккаунт?</span> <router-link to="/login">Войти</router-link>
          </div>
        </form>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      printedText: '',
      printedAuthor: '',
      titleToPrint: 'П У Т Ь',
      textToPrint: 'Даже самое далёкое путешествие начинается с первого шага.',
      authorToPrint: 'Лао-цзы',
      titleFinished: false,
      textFinished: false,
...
.input-icon .icon-mail {
  ...
  width: 1.2rem;
  height: 1.2rem;
  background: url('data:image/svg+xml;utf8,<svg fill="%235656D6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 2v.01L12 13 4 6.01V6h16zM4 20V8.99l8 7 8-7V20H4z"/></svg>') no-repeat center/contain;
  opacity: 0.7;
}
